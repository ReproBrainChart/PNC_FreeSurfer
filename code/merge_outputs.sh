#!/bin/bash
set -e -u -x
outputsource=ria+file:///cbica/projects/RBC/freesurfer_stats/PNC/fs-tabulate/output_ria#da925640-e6e2-4c4b-ba6a-60af03fb9014
cd /cbica/projects/RBC/freesurfer_stats/PNC/fs-tabulate
